// EQUIFAX Grading Engine
// Reuses CIBIL grading logic, adapted for EQUIFAX data format
(function() {
    var CIBILConstants = require('../../cibil/api/cibil-constants.js');

    function EquifaxGradingEngine(equifaxData) {
        this.equifaxData = equifaxData;
        this.creditReport = equifaxData.credit_report || {};
        this.userInfo = {
    ...
    // Parse payment history (EQUIFAX format - similar to CIBIL)
    EquifaxGradingEngine.prototype.parsePaymentHistory = function(account) {
    ...
    EquifaxGradingEngine.prototype.categorizePaymentStatus = function(status) {
    ...
    // Calculate overall grade (EQUIFAX uses same scoring as CIBIL)
    EquifaxGradingEngine.prototype.calculateOverallGrade = function() {
        try {
            var scores = {
            ...
            // EQUIFAX weightings (same as CIBIL for consistency)
            var totalScore = (
            ...
            console.error('Error calculating EQUIFAX overall grade:', error);
            return 'C';
        }
    };

    // Convert score to grade (same as CIBIL)
    EquifaxGradingEngine.prototype.convertScoreToGrade = function(score) {
    ...
    EquifaxGradingEngine.prototype.calculatePaymentHistoryComponent = function() {
    ...
    EquifaxGradingEngine.prototype.calculateUtilizationComponent = function() {
        var accounts = this.creditReport.accounts || [];
        var totalLimit = 0;
        var totalBalance = 0;
    ...
    EquifaxGradingEngine.prototype.calculateCreditAgeComponent = function() {
        var accounts = this.creditReport.accounts || [];
    ...
    EquifaxGradingEngine.prototype.calculateCreditMixComponent = function() {
        var accounts = this.creditReport.accounts || [];
        if (accounts.length === 0) return 600;
    ...
    EquifaxGradingEngine.prototype.calculateRecentBehaviourComponent = function() {
        var accounts = this.creditReport.accounts || [];
    ...
    EquifaxGradingEngine.prototype.getAccountAge = function(account) {
    ...
    EquifaxGradingEngine.prototype.calculatePaymentHistoryScore = function(categories, total) {
    ...
    EquifaxGradingEngine.prototype.getCreditUtilization = function() {
        var accounts = this.creditReport.accounts || [];
        var totalLimit = 0;
        var totalBalance = 0;
    ...
    EquifaxGradingEngine.prototype.getCreditAge = function() {
        var accounts = this.creditReport.accounts || [];
    ...
    // Identify defaulters
    EquifaxGradingEngine.prototype.identifyDefaulters = function() {
        var accounts = this.creditReport.accounts || [];
        var defaulters = [];
    ...
    EquifaxGradingEngine.prototype.generateRecommendations = function() {
        var recommendations = [];
    ...
    EquifaxGradingEngine.prototype.getOverallPaymentAnalysis = function() {
        var accounts = this.creditReport.accounts || [];
        var totalOnTime = 0;
        var totalDelayed = 0;
        var totalMissed = 0;
    ...
    EquifaxGradingEngine.prototype.getComponentScores = function() {
        return {
            paymentHistory: this.calculatePaymentHistoryComponent(),
            creditUtilization: this.calculateUtilizationComponent(),
            creditAge: this.calculateCreditAgeComponent(),
    ...
    module.exports = EquifaxGradingEngine;
})();
