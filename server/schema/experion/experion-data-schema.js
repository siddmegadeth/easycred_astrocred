// EXPERION Credit Bureau Data Schema
// Based on CIBIL schema structure, adapted for EXPERION format
(function() {
    
    // EXPERION Enquiry Schema
    ExperionEnquirySchema = module.exports = mongoose.Schema({
        index: String,
        enquiryDate: String,
    ...
    // EXPERION Account Schema
    ExperionAccountSchema = module.exports = mongoose.Schema({
        index: String,
        memberShortName: String,
        accountType: String,
    ...
    // Main EXPERION Data Schema
    ExperionDataSchema = module.exports = mongoose.Schema({
        ...
        credit_report: [{
            ...
            accounts: [ExperionAccountSchema],
            enquiries: [ExperionEnquirySchema],
            response: {
                consumerSummaryresp: {
                    accountSummary: {
    ...
    ExperionDataModel = module.exports = mongoose.model("ExperionDataModel", ExperionDataSchema);
})();
